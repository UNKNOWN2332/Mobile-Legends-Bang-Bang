...
To build the final jar and optimize the MobileLegends application for production, run:
...
[service discovery and configuration with consul]: https://www.jhipster.tech/documentation-archive/v7.9.2/microservices-architecture/#consul
