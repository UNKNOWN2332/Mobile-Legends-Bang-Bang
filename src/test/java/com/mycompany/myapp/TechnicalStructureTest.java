...
@AnalyzeClasses(packagesOf = MobileLegendsApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(MobileLegendsApp.class), alwaysTrue())
